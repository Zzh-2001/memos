...
export type CreateUserRequest = Message<"memos.api.v1.CreateUserRequest"> & {
  ...
  /**
   * Optional. The invite code for registration.
   * Required when instance has registration_invite_code configured.
   *
