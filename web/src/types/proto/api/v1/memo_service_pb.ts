...
export type Memo = Message<"memos.api.v1.Memo"> & {
  ...
  /**
   * Output only. The total number of comments including nested comments.
   *
   * @generated from field: int32 comment_count = 19;
   */
  commentCount: number;
};
