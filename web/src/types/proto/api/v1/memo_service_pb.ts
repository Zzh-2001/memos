...
export type Memo = Message<"memos.api.v1.Memo"> & {
  ...
  /**
   * Whether AI auto-reply is enabled for this memo.
   *
   * @generated from field: bool enable_ai_reply = 20;
   */
