...
type MemoPayload struct {
	...
	EnableAiReply bool `protobuf:"varint,4,opt,name=enable_ai_reply,json=enableAiReply,proto3" json:"enable_ai_reply,omitempty"`
...
func (x *MemoPayload) GetEnableAiReply() bool {
	if x != nil {
...
const file_store_memo_proto_rawDesc = "" +
	"\n" +
	"\x10store/memo.proto\x12\vmemos.store\"\xde\x03\n" +
	"\vMemoPayload\x12=\n" +
	...
	"\x0fenable_ai_reply\x18\x04 \x01(\bR\renableAiReply\x1a\xac\x01\n" +
	"\bProperty\x12\x19\n" +
